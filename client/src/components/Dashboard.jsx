...
let Dashboard = () => {
   ...
   const getProfile = async() =>{
    let {status,data} = await axios.get("https://developroom-backend.onrender.com/api/profiles/me",{
      headers: {
 ...
 setLoading(false);
  ...
  let clickDeleteExperience = async(experienceId) => {
    const {data} = await axios.delete(`https://developroom-backend.onrender.com/api/profiles/experience/${experienceId}`,{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickDeleteEducation = async(educationId) => {
   const { data } = await axios.delete(
     ` https://developroom-backend.onrender.com/api/profiles/education/${educationId}`,
     {
       headers: {
         "Content-Type": "application/json",
         Authorization: `Bearer ${localStorage.getItem("devroom")}`,
