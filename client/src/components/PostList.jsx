...
let PostList = () => {
 ...
 useEffect(() => {
  ...
  function timeDifference(current, previous) {
   ...
   const getUser = async () => {
     let { data } = await axios.get("https://developroom-backend.onrender.com/api/users/me", {
       headers: {
    ...
    const getPosts = async () => {
      let { data } = await axios.get("https://developroom-backend.onrender.com/api/posts/", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("devroom")}`,
        },
  ...
  let submitCreatePost = async(e) => {
    ...
    {
      const {data} =  await axios.post("https://developroom-backend.onrender.com/api/posts/",localPost,{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickDeletePost = async (postId) => {
    const { data } = await axios.delete(`https://developroom-backend.onrender.com/api/posts/${postId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickLikePost = async(postId) => {
    const {data} = await axios.put(`https://developroom-backend.onrender.com/api/posts/like/${postId}`,{},{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      }
