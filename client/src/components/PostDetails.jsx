...
let PostDetails = () => {
 ...
 useEffect(() => {
  ...
  let getPost = async() =>{
    let { data } = await axios.get(`https://developroom-backend.onrender.com/api/posts/${postId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let submitCreateComment = async(e) => {
    e.preventDefault();
    await axios.post(`https://developroom-backend.onrender.com/api/posts/comment/${postId}`, comment, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickDeleteComment = async(commentId) => {
    ...
    await axios.delete(`https://developroom-backend.onrender.com/api/posts/comment/${postId}/${commentId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
